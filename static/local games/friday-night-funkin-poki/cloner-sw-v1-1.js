...
self.addEventListener("fetch", (event) => {
    ...
    if (!url.startsWith(GAME_PATH) && !url.startsWith("https://ubg235.pages.dev/")) {
        ...
        const REPLACEs= {
            ...
            // Azerion
            "https://cdn.jsdelivr.net/npm/@orange-games/phaser-ads@2.2/build/phaser-ads.min.js": "./patch/phaser/ads/phaser-ads.min-2.2.js",
            "https://cdn.jsdelivr.net/npm/@azerion/phaser-ads@2.2/build/phaser-ads.min.js": "./patch/phaser/ads/phaser-ads-2.2.js",
            ...
            "https://api.gameanalytics.com/": "./patch/null.js",
            "http://localhost:8080/": "./",
        };
        ...
        for (const [matchUrl, replaceUrl] of Object.entries(REPLACEs)) {
            if (url.startsWith(matchUrl)) {
                ...
                event.respondWith(fetch(replace_url));
                return;
            }
        }
