...
const SDK_INTERFACE_SETTINGS = {
	...
	// files to load
	externalFiles: ["migrateIDB.js", "//assets.msn.com/staticsb/statics/latest/msstart-games-sdk/msstart-v1.0.0-rc.19.min.js", "sdk_interface_custom.js"],
...
const SDK_INTERFACE_HELPERS = {
	...
	$msstart: {
		...
		notifyGameMuted: function() {
			SDK_INTERFACE_HELPERS.log("$msstart.notifyGameMuted()");
			$msstart.notifyGameMuted();
		},

		notifyGameUnmuted: function() {
			SDK_INTERFACE_HELPERS.log("$msstart.notifyGameUnmuted()");
			$msstart.notifyGameUnmuted();
		}
	}
};
...
const SDK_INTERFACE_INIT = function() {
	return new Promise(function(resolve, reject) {
		let interval = setInterval(() => {
			if(typeof $msstart !== "undefined" && typeof migrateIDB !== "undefined") {
